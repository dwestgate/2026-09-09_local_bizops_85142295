...
from ananta.interfaces import InferenceRequest, InferenceServiceUnavailableError  # noqa: E402
...
def test_unavailable_boot_degrades_then_recovers() -> None:
    ...
    try:
        ...
        _check(
            plugin.get_readiness_error() == "LM Studio not available at http://localhost:1234/v1",
        ...
        wait_lines = [line for line in capture.messages if "LM Studio not reachable" in line]
