...
from agent_messaging_plugin.lane_worktrees import LaneWorktree, LaneWorktreeSweep  # noqa: E402
...
def _assert_cross_repository_provision_and_retire() -> None:
    ...
    with tempfile.TemporaryDirectory() as raw:
        ...
        try:
            lifecycle_verbs._active_lane_worktree_paths = lambda _state, _root: ()  # type: ignore[assignment]  # noqa: SLF001
